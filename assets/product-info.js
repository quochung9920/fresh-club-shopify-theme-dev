    ...
    class ProductInfo extends HTMLElement {
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          this.updateProductFormInventory(html);
      ...
      updateProductFormInventory(html) {
        const stockFormKey = this.productForm?.dataset.stockFormKey?.replaceAll('quickadd-', '');
        const sourceProductForm = Array.from(html.querySelectorAll('product-form[data-stock-form-key]')).find(
          (productForm) => productForm.dataset.stockFormKey.replaceAll('quickadd-', '') === stockFormKey
        );
        this.productForm?.updateInventoryFrom(sourceProductForm);
      }
