if (!customElements.get('quick-add-bulk')) {
  customElements.define(
    ...
    class QuickAddBulk extends BulkAdd {
      constructor() {
        super();
        this.quantity = this.querySelector('quantity-input-custom');
      ...
      get input() {
        return this.querySelector('quantity-input-custom input');
      }
      ...
      selectLoadingSpinner() {
        return this.querySelector('.loading__spinner');
      }

      selectATCText() {
        return this.querySelector('.submit_btn .atc-text');
      }
      ...
      updateMultipleQty(items) {
        this.selectLoadingSpinner().classList.remove('hidden');
        this.selectATCText()?.classList.add('hidden');
        ...
        fetch(`${routes.cart_update_url}`, { ...fetchConfig(), ...{ body } })
          ...
          .catch(() => {
            ...
            // this.selectLoadingSpinner().classList.add('hidden');
            //this.selectATCText()?.classList.remove('hidden');
            // e.target.select();
